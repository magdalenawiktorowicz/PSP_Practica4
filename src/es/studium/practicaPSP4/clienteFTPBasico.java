			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if (nombreCarpeta.startsWith("(DIR)"))
				{
					...
					try
					{
						...
						// si el input del usuario no está vacío, ni contiene solo los espacios en
						// blanco
		...
		botonRenombrar.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if (!nombreFichero.startsWith("(DIR)"))
				{
					...
					// utilizar un stream con una expresión lambda para separar el nombre y la
					// extensión y reducir el resultado a la extensión
